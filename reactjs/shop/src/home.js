...
class Home extends React.Component {
  constructor(props) {
    ...
    //create state object
    this.state = {
      //create array inside state object
      categories: []
    }
  }
                    ...
                    <Link to='' className="text-decoration-none text-inherit">
                      ...
                      <div className="card card-product shadow">
                        <div className="card-body text-center py-8">
                          {/* img */}
                          <img src={"http://theeasylearnacademy.com/shop/images/category/" + item.photo} alt="Grocery Ecommerce Template" className="img-fluid mb-3" />
                          {/* text */}
